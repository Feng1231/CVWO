...
import { User, Post, Category1, UserProps } from './App.types';
import { userLogout, userSignedIn } from './components/apiRequests';
...
const App = () => {
    ...
    : (
        ...
        <Router>
            <Routes>
                <Route index element={<Home user={user} category={generalCat} handleLogout={handleLogout}/>} />
                <Route path='/' element={<Home user={user} category={generalCat} handleLogout={handleLogout}/>} />
                <Route path='/Home' element={<Home user={user} category={generalCat} handleLogout={handleLogout}/>} />
                ...
                <Route path="/users/:id" element= {<Profile user={user} handleModal={handleModal} handleLogout={handleLogout}/>}/>
                <Route path='/:category/:categoryID' element= {<Category user={user} handleModal={handleModal} handleLogout={handleLogout}/>} />
